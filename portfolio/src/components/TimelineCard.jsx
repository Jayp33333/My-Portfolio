  ...
  return (
    <div className='container mx-auto  border-l-4 border-primary relative'>
      ...
      <div className='flex pb-10 pl-10 '>
        <div className=''>
          <h3 className='text-[14px] sm:text-[20px] text-[white] font-medium'>{title}</h3>
          <p className='text-[10px] sm:text-[14px] text-[gray]'>{institution}</p>
          <p className='text-[10px] sm:text-[14px] text-primary font-semibold'>{date}</p>
